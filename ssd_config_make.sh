...
#define NAND_4KB_READ_LATENCY_LSB (${3}) //ns
#define NAND_4KB_READ_LATENCY_MSB (${3}) //ns
#define NAND_4KB_READ_LATENCY_CSB (${3}) //not used
#define NAND_READ_LATENCY_LSB (${4})
#define NAND_READ_LATENCY_MSB (${4})
#define NAND_READ_LATENCY_CSB (${4})
#define NAND_PROG_LATENCY (${5})
#define NAND_ERASE_LATENCY (${5})

#define FW_4KB_READ_LATENCY (${6})
#define FW_READ_LATENCY (${7})
#define FW_WBUF_LATENCY0 (${8})
#define FW_WBUF_LATENCY1 (${9})
#define FW_CH_XFER_LATENCY (${10})
#define OP_AREA_PERCENT (0.15)

#define GLOBAL_WB_SIZE KB(${11})
