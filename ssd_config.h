...
#define NAND_CHANNEL_BANDWIDTH (640ull) //MB/s
#define PCIE_BANDWIDTH (3400ull) //MB/s

#define NAND_4KB_READ_LATENCY_LSB (100000) //ns
#define NAND_4KB_READ_LATENCY_MSB (100000) //ns
#define NAND_4KB_READ_LATENCY_CSB (100000) //not used
#define NAND_READ_LATENCY_LSB (68743)
#define NAND_READ_LATENCY_MSB (68743)
#define NAND_READ_LATENCY_CSB (68743)
#define NAND_PROG_LATENCY (3300000)
#define NAND_ERASE_LATENCY (3300000)

#define FW_4KB_READ_LATENCY (9530)
#define FW_READ_LATENCY (14483)
#define FW_WBUF_LATENCY0 (10277)
#define FW_WBUF_LATENCY1 (1200)
#define FW_CH_XFER_LATENCY (3500)
#define OP_AREA_PERCENT (0.15)

#define GLOBAL_WB_SIZE KB(6144)
