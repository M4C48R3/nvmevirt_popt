...
#define NAND_4KB_READ_LATENCY_LSB (72954) //ns
#define NAND_4KB_READ_LATENCY_MSB (72954) //ns
#define NAND_4KB_READ_LATENCY_CSB (72954) //not used
#define NAND_READ_LATENCY_LSB (74818)
#define NAND_READ_LATENCY_MSB (74818)
#define NAND_READ_LATENCY_CSB (74818)
#define NAND_PROG_LATENCY (3300000)
#define NAND_ERASE_LATENCY (3300000)

#define FW_4KB_READ_LATENCY (12764)
#define FW_READ_LATENCY (20000)
#define FW_WBUF_LATENCY0 (7368)
#define FW_WBUF_LATENCY1 (113)
#define FW_CH_XFER_LATENCY (1314)
#define OP_AREA_PERCENT (0.15)

#define GLOBAL_WB_SIZE KB(65536)
